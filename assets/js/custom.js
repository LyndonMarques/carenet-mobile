...
jQuery(document).ready(function($){
    ...
    function slideBeforeChange() {
        var index = $('#mainSlider').data('nivo:vars').currentSlide;
        ...
        $slide_texts.eq(index).fadeOut($transition_time);
    }
	...
	function slideChanged() {
        ...
        $slide_texts.eq(index).fadeIn($transition_time);
    }
	...
	$('#mainSlider').nivoSlider({
        ...
        afterChange: slideChanged,    // Triggers after a slide transition
        afterLoad: slideChanged    // Triggers after a slide transition
	});
